...
void custom_range_test(void)
{
    ...
    TEST_ASSERT_TRUE(SAI_PORT_LLR_PROFILE_ATTR_CUSTOM_RANGE_START == 0x10000000, "invalid custom range start for PORT_LLR_PROFILE");
    TEST_ASSERT_TRUE(SAI_PORT_LLR_PROFILE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for PORT_LLR_PROFILE");
...
void enum_size_check_test(void)
{
    ...
    TEST_ASSERT_TRUE((sizeof(sai_llr_frame_action_t) == sizeof(int32_t)), "invalid enum sai_llr_frame_action_t size");
    ...
    TEST_ASSERT_TRUE((sizeof(sai_port_llr_profile_attr_t) == sizeof(int32_t)), "invalid enum sai_port_llr_profile_attr_t size");
    TEST_ASSERT_TRUE((sizeof(sai_port_llr_rx_status_t) == sizeof(int32_t)), "invalid enum sai_port_llr_rx_status_t size");
    TEST_ASSERT_TRUE((sizeof(sai_port_llr_tx_status_t) == sizeof(int32_t)), "invalid enum sai_port_llr_tx_status_t size");
...
void api_name_test(void)
{
    ...
    {
        sai_port_api_t port_api = { 0 };
        sai_generic_create_fn create = port_api.create_port_llr_profile;
        sai_generic_remove_fn remove = port_api.remove_port_llr_profile;
        sai_generic_set_fn set = port_api.set_port_llr_profile_attribute;
        sai_generic_get_fn get = port_api.get_port_llr_profile_attribute;
        sai_create_port_llr_profile_fn cr = NULL;
        sai_remove_port_llr_profile_fn re = NULL;
        sai_set_port_llr_profile_attribute_fn se = NULL;
        sai_get_port_llr_profile_attribute_fn ge = NULL;
        dummy = &create;
        dummy = &remove;
        dummy = &set;
        dummy = &get;
...
void custom_range_all_test(void)
{
    ...
    TEST_ASSERT_TRUE(SAI_PORT_LLR_PROFILE_ATTR_CUSTOM_RANGE_START == 0x10000000, "invalid custom range start for SAI_PORT_LLR_PROFILE_ATTR_CUSTOM_RANGE_START");
    TEST_ASSERT_TRUE(SAI_PORT_LLR_PROFILE_ATTR_CUSTOM_RANGE_END < 0x20000000, "invalid custom range end for SAI_PORT_LLR_PROFILE_ATTR_CUSTOM_RANGE_END");
